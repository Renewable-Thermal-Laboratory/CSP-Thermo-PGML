...
for seq_len in SEQUENCE_LENGTH:
    ...
    # Initialize dataset
    dataset = TempSequenceDataset("data/processed", sequence_length=seq_len)
    ...
    print(f"Input shape: [batch, {seq_len}, {input_size}], Target: [{output_size}]")
